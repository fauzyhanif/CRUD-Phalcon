...
<html>
    <head>
		...
		{{ stylesheet_link("css/core.css") }}
		{{ stylesheet_link("css/components.css") }}
		{{ stylesheet_link("css/icons.css") }}
		{{ stylesheet_link("css/pages.css") }}
		{{ stylesheet_link("css/responsive.css") }}
        {{ stylesheet_link("js/modernizr.min.js") }}
        ...
        {{ stylesheet_link("plugins/datatables/dataTables.colVis.css") }}
        {{ stylesheet_link("plugins/datatables/dataTables.bootstrap.min.css") }}
        {{ stylesheet_link("plugins/datatables/fixedColumns.dataTables.min.css") }}
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="{{ url("crud")}}" class="waves-effect"><i class="ti-home"></i> <span> CRUD </span> </a>

                            </li>

                            <li class="has_sub">
                                <a href="{{ url("client")}}" class="waves-effect"><i class=" ti-direction-alt"></i> <span> Rest Client </span> </a>
